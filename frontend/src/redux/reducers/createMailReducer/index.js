...
const createMailReducer = (state = initialState, action) => {
    switch(action.type){
        case CreateMailConstants.OPEN_CREATE_MAIL: return { ...state, open: action.open };
        ...
        case CreateMailConstants.CHANGE_TYPE_OF_MAIL: return { ...state, typeOfMail: action.typeOfMail };
